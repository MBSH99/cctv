        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-select mb-3 @error('lokasi_kod') is-invalid @enderror" id="lokasi_kod" name="lokasi_kod"/>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-select mb-3 @error('lokasi_detail') is-invalid @enderror" id="lokasi_detail" name="lokasi_detail"/>
            </div>
          </div>
        </div>
