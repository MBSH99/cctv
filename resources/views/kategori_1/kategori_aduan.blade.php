        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-select mb-3 @error('aduan_kod') is-invalid @enderror" id="aduan_kod" name="aduan_kod" />
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-select mb-3 @error('aduan_detail') is-invalid @enderror" id="aduan_detail" name="aduan_detail"/>
            </div>
          </div>
        </div>
